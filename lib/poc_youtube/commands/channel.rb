...
module PocYoutube
  module Commands
    ...
    class Channel < PocYoutube::Command
      ...
      # Execute Channel command taking input from a input stream
      ...
      def execute(input: $stdin, output: $stdout)
        ...
        when :gui
          gui
        when :mine
          require_relative 'channel_mine'
          subcmd = PocYoutube::Commands::ChannelMine.new({})
        end
      ...
      def gui
        ...
        command = PocYoutube::Commands::Channel.new(subcommand, {})
